...
ARG MUSA_VERSION_AMD64=rc3.1.1
ARG MUSA_VERSION_ARM64=rc3.1.2
...
ENV CC=clang CXX=clang++
# TODO: MUSA: uncomment below when official musa docker is ready
...
# TODO: MUSA: remove the mirrored download link
...
ENV LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/usr/lib/ollama/musa_v3:/usr/lib/aarch64-linux-gnu/musa
